...
*Feature Engineering & Selection*
   ↓  
*Clustering & Evaluation*  // *Churn Prediction Modeling*  
   ↓  
*Select Best Clustering Algorithm*  // *Feature Importance Analysis*
   ↓  
*Visualization of Clusters* // *Business Insights & Recommendations*

---

## Outlier Detection

![](img/boxplots.png){ width=700px }
...
![](img/skewness_histograms.png){ width=700px }
